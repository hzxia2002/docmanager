...
public class ReflectionUtils {
     ...
     * @return
     */
    public static List<String> getAllField(final Class clazz) {
    ...
    /**
     * 将source里指定属性拷贝到target中
     *
     * @param source 拷贝的源对象
     * @param target 拷贝的目标对象
     * @param fields 要拷贝的属性集
     * @throws Exception
     */
    public static void copyBean(Object source, Object target, String[] fields) throws Exception {
