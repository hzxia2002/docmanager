...
<div id="mainLayout" style="width:100%;overflow-y: hidden;overflow-x: hidden;margin:0; padding:0;">
    <div position="center">
        <div id="query" title="查询条件" icon="search">
            <form id="sysMessageSendBackForm" action="">
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td width="100" align="center">
                            <input type="text" id="fdMessageSendTime1"  name="fdMessageSendTime"
                        ...
                        <td align="left" width="110">
                            <input type="text" id="fdMessageSendTime2"  name="fdMessageSendTime"
                                   style="width: 100px;" op="lessAndEq" dType="date"  entity="t"
                                   class="Wdate" onFocus="WdatePicker({isShowClear:true,readOnly:true})"/>
                        </td>
                        <td>
                            &nbsp;<input type="button" value="查询" onclick="javascript:search('sysMessageSendBackGrid','sysMessageSendBackForm');"/>&nbsp;
                        </td>
                    </tr>
                </table>
        ...
        <div id="sysMessageSendBackGrid" checkbox="true" rownumbers="true"  height="100%"  url='${ctx}/sysMessageSendBack/grid.do' root="rows" record="records"  width="100%"  colDraggable="true" >
        </div>
    </div>
</div>
</body>
...
<script type="text/javascript">
    $(function(){
        ...
        //grid
        $("#sysMessageSendBackGrid").juiceGrid({
            toolbar:toolbar,
            columns: [
...
//        enabledEdit: true
    ...
    function doView(id) {
        var url = "${ctx}/sysMessageSendBack/view.do";

        commonView(url, "sysMessageSendBackGrid");
    }

    function doDelete(){
        commonDelete("sysMessageSendBackGrid","${ctx}/sysMessageSendBack/delete.do");
    }
</script>